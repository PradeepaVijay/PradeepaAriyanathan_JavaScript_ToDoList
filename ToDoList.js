...
var completeTaskHolder = document.getElementById("complete-tasks");//ul of #complete-tasks
...
//function for adding tasks in the list
...
for (var i = 0; i < completeTaskHolder.children.length; i++) {
	...
	bindTaskEvents(completeTaskHolder.children[i], taskCompleted);
}
